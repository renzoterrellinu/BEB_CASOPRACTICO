 ...
 * @author renzo
 */
public class GestionPlanes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 153, 102), new java.awt.Color(0, 153, 102)));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\ESTUDIANTE\\Desktop\\IMG\\proyecto.png")); // NOI18N
        jLabel1.setText("                                         Gestion de Planes");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
        String sql = "INSERT INTO planes_inversion (tipo_plan, monto, rentabilidad, id_cliente) VALUES (?, ?, ?, ?)";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
        String sql = "UPDATE planes_inversion SET tipo_plan=?, monto=?, rentabilidad=?, id_cliente=? WHERE id_plan=?";
        ...
        ps.setDouble(3, Double.parseDouble(jTextField4.getText()));
        ps.setInt(4, Integer.parseInt(jTextField5.getText()));
        ps.setInt(5, Integer.parseInt(jTextField1.getText())); // ID
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
        String sql = "DELETE FROM planes_inversion WHERE id_plan=?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionPlanes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionPlanes().setVisible(true);
            }
        });
    }
