...
public class GestionCuentas extends javax.swing.JFrame {
    ...
    try {
        ...
        ResultSet rs = st.executeQuery("SELECT * FROM cuentas_ahorro");
    ...
    private void initComponents() {
        ...
        jButton4.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(255, 51, 51), new java.awt.Color(255, 0, 0)));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\ESTUDIANTE\\Desktop\\IMG\\empresario.png")); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
          try {
        String sql = "INSERT INTO cuentas_ahorro(saldo, fecha_apertura, id_cliente) VALUES (?, ?, ?)";

        PreparedStatement ps = conn.prepareStatement(sql);
        ps.setDouble(1, Double.parseDouble(jTextField2.getText()));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         try {
        String sql = "UPDATE cuentas_ahorro SET saldo=?, fecha_apertura=?, id_cliente=? WHERE id_cuenta=?";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
         try {
        String sql = "DELETE FROM cuentas_ahorro WHERE id_cuenta=?";
